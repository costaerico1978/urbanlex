...
12. CAMPOS COM AUTOCOMPLETE (como campo de cidade/municipio): apos digitar, AGUARDE a lista de sugestoes aparecer na tela. Em seguida, CLIQUE na primeira sugestao correspondente da lista — nao apenas digite e submeta. Se a lista nao aparecer, tente digitar apenas as primeiras letras. O sistema so reconhece o municipio se voce SELECIONAR da lista de autocomplete.
