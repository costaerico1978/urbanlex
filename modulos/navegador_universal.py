...
13. LEISMUNICIPAIS.COM.BR — siga EXATAMENTE esta sequencia, sem pular passos:
    ...
    (g) Nos resultados, clicar SOMENTE no TITULO da legislacao (texto em vermelho). ANTES de clicar, inspecione o href do titulo: se o href NAO comecar com "https://leismunicipais.com.br" (ex: aponta para "leis.org", "bit.ly" ou qualquer outro dominio), IGNORE esse resultado completamente e continue procurando na lista. Somente clique se o href comecar com "https://leismunicipais.com.br".
