        ...
        if _onclick_fn:
            ...
            def _on_dialog(dialog):
                ...
                try:
                    ...
                    pass
            # context-level: captura dialogs de popup também
            try:
            ...
            # Timeout curto (5s): LC 270 dispara download logo após alert+OK.
            # LC 198 não dispara download → timeout silencioso → vai para popup.
            try:
                with page.context.expect_event('download', timeout=5000) as _dl_primary:
                    el.click()
                ...
                try: page.context.remove_listener('dialog', _on_dialog)
            ...
            try:
                page.context.remove_listener('dialog', _on_dialog)
            except Exception:
                try:
