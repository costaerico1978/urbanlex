...
13. LEISMUNICIPAIS.COM.BR — siga EXATAMENTE esta sequencia, sem pular passos:
    ...
    (g) Nos resultados: SE a pagina mostrar "0 atos encontrados" ou "nenhum resultado" — usar acao "desistir" com status "nenhum_resultado_relevante" IMEDIATAMENTE sem tentar novamente. NAO tente reformular a busca. O sistema fara o fallback automaticamente.
