...
ACOES DISPONIVEIS:
- "clicar": clicar em algo. Informe a bounding box do elemento: [y_min, x_min, y_max, x_max] (0-1000).
- "digitar": clicar num campo e digitar texto. Informe box_2d do campo + texto.
- "selecionar": abrir um dropdown. Informe box_2d.
- "preencher_formulario": preencher TODOS os campos de um formulario de uma vez e submeter.
- "scroll": rolar pagina ("baixo" ou "cima")
- "concluido": encontrei a legislacao (informar URL)
- "desistir": nao consigo encontrar

REGRAS OBRIGATORIAS:
1. NUNCA use campos de palavra-chave/busca por texto. Prefira busca por data/edicao/numero.
2. DIARIOS OFICIAIS: se o site parece ser um diario oficial e tem campo para buscar por data de UMA edicao (nao intervalo), faca assim: busque pela data de assinatura da legislacao (ex: 14/01/2019). Baixe o PDF dessa edicao. Se a legislacao nao estiver nessa edicao, volte e tente o dia seguinte (15/01/2019), depois o proximo, ate 5 dias. A data de assinatura nem sempre coincide com a de publicacao no DO.
3. Se houver campo "Esfera", selecione sempre "Municipal".
4. Se houver campo para numero da legislacao, informe APENAS o numeral (ex: "198").
...
8. COORDENADAS: use bounding box [y_min, x_min, y_max, x_max] normalizado de 0 a 1000. O sistema calcula o centro automaticamente.
9. FORMULARIOS: se o formulario tem dropdowns e campos simples, use "preencher_formulario". Se tem datepickers ou widgets especiais, use "clicar" e "digitar".
10. Se "preencher_formulario" falhou, mude para "clicar" e "digitar".
11. Se houver campo de RANGE DE DATAS (Data Inicial / Data Final) em sites que NAO sao diarios oficiais, preencha Data Inicial com a data de publicacao e Data Final com +5 dias. Em diarios oficiais, use busca por edicao unica (regra 2).
12. Sempre que possivel, BAIXE O ARQUIVO EM PDF.
13. Se o clique nao funcionou, tente coordenadas ligeiramente diferentes.
14. Se a pagina ja mostra o conteudo buscado (edicao carregada, preview visivel, botoes PDF/HTML apareceram), NAO clique em buscar de novo — clique no botao de DOWNLOAD (PDF).
...
{{
    ...
    "acao": {{
        ...
        "campos": [
            ...
            {{"label": "No do Ato", "valor": "198", "tipo_campo": "input"}},
