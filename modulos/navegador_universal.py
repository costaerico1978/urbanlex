    ...
    try:
        ...
        if _onclick_fn:
            ...
            if _direct_url:
                ...
                _page_a1 = None
                try:
                    # Abrir nova aba para não destruir a página original com el
                    _page_a1 = page.context.new_page()
                    with page.context.expect_event('download', timeout=20000) as _dl_a1:
                        _page_a1.goto(_abs_url_a1, wait_until='commit', timeout=20000)
...
def navegar_como_humano(
    ...
    for passo in range(1, max_passos + 1):
        try:
            ...
            # 5. Extrair campos
            o_que_vejo = (decisao.get('o_que_vejo', '') or '')[:300]
            ...
            logs.append({'nivel': 'info', 'msg': f'{label}: 🧠 Decisão: {tipo_acao} — {pensamento[:150]}'})
