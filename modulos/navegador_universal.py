...
13. LEISMUNICIPAIS.COM.BR — siga EXATAMENTE esta sequencia, sem pular passos:
    ...
    (e) Filtrar por ano: clicar em "Qualquer data" para expandir o filtro de datas. Usar acao "digitar" no campo "A partir de" com "01/01/ANO" (ANO = ano real da lei, ex: 01/01/2023). Em seguida OBRIGATORIAMENTE clicar no dropdown "Ate" (que mostra "Proximos 12 meses" ou similar) para abri-lo, e depois clicar na opcao "Proximos 12 meses" — o campo Ate e um dropdown CUSTOMIZADO, NAO use preencher_formulario. MESMO QUE JA MOSTRE "Proximos 12 meses", voce DEVE clicar para garantir que o valor esta realmente selecionado. Apos preencher os dois campos prosseguir imediatamente para (f). CRITICO: apos preencher as datas, o dropdown de tipo de ato pode exibir "1 Ato selecionado" — isso e NORMAL e significa que o tipo ja esta corretamente selecionado desde o passo (c). NAO clique nele novamente.
