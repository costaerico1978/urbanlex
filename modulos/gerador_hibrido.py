...
def prompt_passada_2_pdf_driven_principal(prompt_usuario, lei_identificacao, zonas_canonicas,
    ...
    return prompt_usuario + (
        ...
        f'\n========================================\n'
        f'!! REGRA OBRIGATORIA — NAO HA EXCECAO !!\n'
        f'========================================\n'
        f'EXEMPLO DE SAIDA CORRETA (zona ZR1 onde Bloco 4 tem Comercial=NAO):\n'
        f'  "Comercial": "NAO",\n'
        f'  "Taxa de Ocupacao Comercial (%)": "Not Allowed",\n'
        f'  "Coeficiente de Aproveitamento Comercial": "Not Allowed",\n'
        f'  "Gabarito Maximo Comercial (pavimentos)": "Not Allowed",\n'
        f'  ... todas as 22 colunas do bloco Comercial = "Not Allowed"\n\n'
        f'AUTO-CHECAGEM antes de retornar: para CADA uso=NAO no Bloco 4, todas\n'
        f'as 22 colunas daquele bloco devem conter "Not Allowed". Se vazias, CORRIJA.\n\n'
        f'\n=== REGRAS CRITICAS DE PREENCHIMENTO POR USO (ver Parte 12.5-bis do prompt principal) ===\n'
        f'Para CADA zona, voce deve preencher os blocos por uso (Residencial Unifamiliar,\n'
        f'Multifamiliar, HIS, Comercial, Servicos, Misto, Industrial, Institucional) seguindo:\n\n'
        f'1) Se a lei da um valor GERAL pra zona (ex: "TO max = 50%"), REPLIQUE esse valor\n'
        f'   em TODOS os blocos cujo uso esteja como SIM no Bloco 4.\n'
        f'2) Se a lei da valor ESPECIFICO pra um uso, use no bloco daquele uso e o valor\n'
        f'   geral nos demais usos permitidos.\n'
        f'3) Para usos marcados como NAO no Bloco 4, PREENCHA TODAS as 22 colunas do bloco\n'
        f'   daquele uso com a string "Not Allowed" (literal, com aspas). NAO omita, NAO\n'
        f'   deixe vazio, NAO use "{campo_ni}".\n\n'
