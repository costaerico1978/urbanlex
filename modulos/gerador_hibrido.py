...
def prompt_passada_2_pdf_driven_principal(prompt_usuario, lei_identificacao, zonas_canonicas,
    ...
    return prompt_usuario + (
        ...
        f'\n========================================\n'
        f'!! REGRAS ANTI-ALUCINACAO — APLICAR ANTES DE TUDO !!\n'
        f'========================================\n'
        f'REGRA A — Leia LITERALMENTE a lista de "USOS PERMITIDOS" no Anexo de cada zona.\n'
        f'  Liste cada uso EXATAMENTE como aparece. NUNCA infira usos a partir do nome\n'
        f'  ou descricao da zona.\n'
        f'  EXEMPLOS DO QUE NAO FAZER:\n'
        f'  - "ZCS e Zona Comercial e Servicos, entao residencial nao deve ser permitido" ERRADO\n'
        f'  - "Zona Industrial nao admite residencial" ERRADO\n'
        f'  - "Zona Especial Institucional so permite uso institucional" ERRADO\n'
        f'  Em todos esses casos, voce deve LER a tabela. Muitas zonas comerciais\n'
        f'  permitem residencial; muitas industriais permitem comercial; etc.\n\n'
        f'REGRA B — Se um parametro NAO esta no Anexo da zona, OMITA a chave.\n'
        f'  NUNCA invente valor por:\n'
        f'  - Similaridade com outras zonas ("ZC2 tem CA 4.0 entao ZC1 tambem deve ter")\n'
        f'  - Regra geral do plano diretor ("planos diretores costumam ter CA entre 2 e 6")\n'
        f'  - Conhecimento previo sobre planos diretores brasileiros\n'
        f'  "Nao sei" (omitir) e melhor que "chutei plausivel".\n\n'
        f'REGRA C — Auto-verificacao OBRIGATORIA antes de retornar JSON:\n'
        f'  Para CADA chave numerica que gravar, voce deve poder responder:\n'
        f'  "Vi este valor EXPLICITAMENTE em qual trecho do Anexo/lei enviado?"\n'
        f'  Se nao puder responder com trecho concreto, REMOVA a chave do JSON.\n'
        f'  Se puder citar fonte, mantenha.\n\n'
        f'\n========================================\n'
        f'!! REGRA OBRIGATORIA — BLOCO 4 + REPLICACAO POR USO !!\n'
        f'========================================\n'
        f'Os usos do Bloco 4 sao: Residencial Unifamiliar, Multifamiliar, HIS, Comercial,\n'
        f'Servicos, Misto, Industrial, Institucional. Cada uso tem 22 colunas no seu bloco\n'
        f'(Blocos 5-12: TO basica/maxima, CA basico/maximo, gabarito pav/altura, afastamentos\n'
        f'frontal/lateral/fundos, etc.).\n\n'
        f'Para CADA uso, decida em qual dos 4 CASOS abaixo se enquadra na lei:\n\n'
        f'CASO 1 — Lei PERMITE o uso na zona (mesmo se for "permitido com condicao",\n'
        f'         "condicionado", "tolerado", "permitido para apoio", etc.):\n'
        f'  Bloco 4 = "SIM"\n'
        f'  22 colunas do bloco: replicar o valor GERAL da zona se a lei nao distinguir,\n'
        f'  OU usar o valor ESPECIFICO do uso quando a lei disser explicitamente.\n'
        f'  NAO usar "CONDICIONADO" / "Permitido com restricoes" / similar — use SIM.\n\n'
        f'CASO 2 — Lei PROIBE explicitamente o uso na zona\n'
        f'         (ex: "ZR1 admite apenas residencial unifamiliar e multifamiliar"\n'
        f'          ou "uso comercial nao permitido em ZR1"):\n'
        f'  Bloco 4 = "NAO"\n'
        f'  22 colunas do bloco: TODAS preenchidas com "Not Allowed" (literal, com aspas).\n'
        f'  NAO omita. NAO deixe vazio. NAO use "{campo_ni}". USE "Not Allowed" LITERAL.\n\n'
        f'CASO 3 — Lei NAO MENCIONA o uso na zona (silencio total — lei nao diz nem que\n'
        f'         e permitido nem que e proibido):\n'
        f'  Bloco 4 = "{campo_ni}"\n'
        f'  22 colunas do bloco: omitir as chaves (nao retornar).\n\n'
        f'EXEMPLO DE SAIDA CORRETA (ZR1: lei diz "exclusivamente residencial unifamiliar"):\n'
        f'  "Residencial Unifamiliar": "SIM",\n'
        f'  "Tx. Ocupacao basica\\nResidencial Unifamiliar": "50",  (replicado da zona)\n'
        f'  "Comercial": "NAO",\n'
        f'  "Tx. Ocupacao basica\\nComercial": "Not Allowed",\n'
        f'  "Coeficiente de aproveitamento basico\\nComercial": "Not Allowed",\n'
        f'  ... todas as 22 colunas do bloco Comercial = "Not Allowed"\n\n'
        f'AUTO-CHECAGEM OBRIGATORIA antes de retornar:\n'
        f'• Para CADA uso, valor do Bloco 4 e exatamente "SIM", "NAO" ou "{campo_ni}"?\n'
        f'  (NAO e: CONDICIONADO, SIM_COND, "Permitido com condicoes", "Nao Permitido")\n'
        f'• Para CADA uso = "NAO", as 22 colunas do bloco contem "Not Allowed"?\n'
        f'• Para CADA uso = "SIM", os valores gerais da zona foram replicados nas 22 cols?\n'
        f'• Se algum bloco esta inconsistente, VOLTE e CORRIJA antes de retornar o JSON.\n\n'
        ...
        f'Para campos sem informacao na lei (NAO se enquadram nas regras 1-3 acima), OMITA\n'
        f'a chave (nao use "{campo_ni}" aqui — omita).\n'
