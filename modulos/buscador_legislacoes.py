...
def _buscar_leismunicipais_direto(municipio: str, estado: str, tipo: str, numero: str, ano: str, logs: list) -> list:
    ...
    try:
        ...
        logs.append({'nivel': 'info', 'msg': 'LeisMunicipais: usando curl_cffi (Chrome TLS fingerprint)'})
    except ImportError:
        try:
            import cloudscraper
        ...
        if resp.status_code != 200:
            ...
            if resp.status_code == 403 and 'leismunicipais.com.br' in url:
                ...
                try:
                    ...
                    _scraper.trust_env = False  # Ignora proxy de ambiente do Railway
                    _cs_resp = _scraper.get(url, timeout=20, allow_redirects=True)
