        ...
        with sync_playwright() as pw:
            ...
            if _bloqueado:
                ...
                if proxy_config:
                    ...
                    if 'request rejected' in body_text.lower() or 'access denied' in body_text.lower():
                        logs.append({'nivel': 'aviso', 'msg': f'{label}: ❌ Proxy também foi bloqueado'})
                        browser.close()
                        return []
            ...
            if resp.status_code == 403:
                ...
                try:
                    ...
                    with _sp() as _pw:
                        ...
                        if len(_body_text) < 100 or 'request rejected' in _bl or 'access denied' in _bl or 'just a moment' in _bl:
