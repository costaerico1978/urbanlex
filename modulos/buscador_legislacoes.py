...
def _busca_manual_core(params, logs, fontes_status):
    ...
    logs.append({'nivel': 'info', 'msg': f'🔍 ETAPA 1: parâmetros — tipo={tipo!r} numero={numero!r} ano={ano!r} municipio={municipio!r} estado={estado!r} data_info={data_publicacao_informada!r}'})
