...
Se sim, para cada zona, informe o status de cada um dos 8 usos:
...
**6.1** Os parâmetros variam dependendo da rua/via para a qual o terreno tem frente?

Se sim, para cada zona afetada, informe:
- Nome da via
- Lado (PAR / IMPAR / AMBOS)
- Trecho (range numérico ou cruzamentos)
...
- [ ] `variacoes.por_via`: capturou variações em vias nomeadas? (verifique CORPO + ERRATA)
