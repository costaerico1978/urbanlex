...
def api_buscador_sites_post():
    ...
    try:
        # Upsert normalizado: primeiro tenta atualizar qualquer registro existente
        # com mesmo municipio_nome (independente do estado salvo anteriormente)
        ...
        if not exists:
            qry("""INSERT INTO municipio_sites_referencia (municipio_nome, estado, url_diario, urls_extras, atualizado_em)
                   ...
                   DO UPDATE SET url_diario = '', urls_extras = EXCLUDED.urls_extras,
                                 atualizado_em = NOW()""",
