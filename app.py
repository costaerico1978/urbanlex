...
def api_monitor_executar_municipio(mid):
    ...
    return jsonify({'success': True, 'message': f'Monitoramento iniciado para {mun["nome"]}'})
...
def api_monitor_municipio_legislacoes(mid):
    data = qry("""SELECT l.id, l.tipo_nome, l.numero, l.ano, l.ementa,
                         l.em_monitoramento, l.data_inicio_monitoramento,
                         l.data_fim_monitoramento, l.ultima_verificacao_monitoramento,
